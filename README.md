...
Verified: - Recruiter account creation - `ROLE_RECRUITER` assignment -
JWT access token - Refresh token - Successful authentication
...
Verified: - JWT authentication - Current recruiter identification -
Profile creation - Profile retrieval - Company information persistence
