        ...
        <div className="relative flex items-center">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className={cn(
                'flex h-11 items-center gap-1.5 rounded-l-lg border border-r-0 border-border bg-surface hover:bg-surface-2 px-3 text-xs font-semibold text-foreground transition-colors focus:outline-none shrink-0 cursor-pointer shadow-xs',
            ...
            {/* Dropdown Menu */}
            {isOpen && (
              <div className="absolute top-full left-0 mt-1.5 w-64 max-h-64 overflow-hidden rounded-lg bg-surface border border-border shadow-xl z-50 flex flex-col animate-in fade-in-50 zoom-in-95">
                {/* Search country */}
                <div className="p-2 border-b border-border sticky top-0 bg-surface">
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-3 py-1.5 text-xs bg-surface-2 rounded-md border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-brand-blue"
                      autoFocus
                    />
                  </div>
                </div>
                ...
                <div className="overflow-y-auto flex-1 p-1">
                  {filteredCountries.map((c) => (
                    <button
                      ...
                      className={cn(
                        'flex items-center justify-between w-full px-3 py-2 rounded-md text-xs text-left transition-colors cursor-pointer',
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 shrink-0 ml-2">
                        ...
                        {c.code === selectedCountryCode && <Check className="w-3.5 h-3.5 text-brand-blue" />}
                      </div>
                    </button>
                  ))}
          ...
          <input
            ...
            className={cn(
              'flex h-11 w-full rounded-r-lg border border-border bg-surface text-foreground px-3.5 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue focus-visible:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-colors shadow-xs font-mono',
