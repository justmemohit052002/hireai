...
export const CurrencySelect = ({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1.5 w-full min-w-[220px] max-h-64 overflow-hidden rounded-lg bg-surface border border-border shadow-xl z-50 flex flex-col animate-in fade-in-50 zoom-in-95">
          {/* Search Bar */}
