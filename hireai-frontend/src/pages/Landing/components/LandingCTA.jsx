      ...
      <div>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-5">
          <Link to={ROUTES.SIGNUP} className="w-full sm:w-auto">
            <Button size="lg" variant="primary" className="w-full sm:w-auto px-8 py-3.5 rounded-full text-lg font-semibold shadow-xl transition">
              Get Started
            </Button>
          </Link>

          <Link to={ROUTES.LOGIN} className="w-full sm:w-auto">
            <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 py-3.5 rounded-full text-lg font-semibold shadow-lg transition">
              Book Demo
            </Button>
          </Link>
        </div>
