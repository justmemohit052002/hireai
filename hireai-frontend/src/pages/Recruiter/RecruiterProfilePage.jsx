            ...
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground flex items-center gap-2">
                ...
                <span className="flex items-center gap-1">
                  <MapPin className="w-3.5 h-3.5 text-primary" /> {companyLocation || 'Location not set'}
                </span>
                <span>•</span>
        ...
        <div className="space-y-6">
          ...
          <Card glass className="p-8 space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-surface-2/60 border border-border/50 flex flex-wrap items-center justify-between gap-4 text-xs text-muted-foreground">
              {companyEmail && (
                <span className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-primary" /> {companyEmail}
                </span>
              )}
              {companyPhone && (
                <span className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-primary" /> {companyPhone}
                </span>
              )}
              {companyLocation && (
                <span className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-primary" /> {companyLocation}
                </span>
              )}
            </div>
          </Card>
